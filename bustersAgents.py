...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        for action in legal:
            ...
            gdist = []
            for pgp in livingGhostPositionDistributions:
                pos = max(pgp, key = pgp.get)
                gdist.append(self.distancer.getDistance(successorPosition, pos))
            minactdist[action] = min(gdist)
        return min(minactdist,key=minactdist.get)
